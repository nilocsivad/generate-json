...
<link rel="stylesheet" href="${URL }/static_r/style/frame.css.css" />
<link rel="stylesheet" href="${URL }/static_r/style/index.css.css" />
</head>
<body>
	...
	<div class="get">
		<div class="am-container">
			...
			<p>期待你的使用，提高您的开发效率</p>
			<p>
				<a href="#" class="am-btn am-btn-sm get-btn">获取新get技能√</a>
			</p>
		</div>
	</div>
